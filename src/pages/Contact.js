    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-20 transition-colors">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          {/* Contact Info */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-md border border-gray-200 dark:border-gray-700 transition-colors">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-gray-700 dark:text-gray-300 font-semibold">LinkedIn</p>
                  <a 
                  ...
                  >
                    linkedin.com/in/dasunika-bandara
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-gray-700 dark:text-gray-300 font-semibold">GitHub</p>
                  <a 
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  } rounded-lg focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 transition-colors bg-white dark:bg-gray-700 text-gray-800 dark:text-white`}
              ...
              <div>
                ...
                <textarea
                  ...
                  } rounded-lg focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 transition-colors resize-none bg-white dark:bg-gray-700 text-gray-800 dark:text-white`}
              ...
              <button
                ...
                className="w-full bg-blue-600 dark:bg-blue-500 text-white py-4 rounded-lg font-bold text-lg hover:bg-blue-500 dark:hover:bg-blue-400 transform hover:scale-105 transition-all duration-300"
              >
                Send Message
              </button>
            </div>
