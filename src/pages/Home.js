  ...
  return (
    <div>
      ...
      <section className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-20 min-h-screen flex items-center">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="p-6 bg-white/60 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <div className="p-6 bg-white/60 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="text-gray-600">Academic Grade</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="fixed right-6 top-1/2 transform -translate-y-1/2 space-y-4 z-50 hidden lg:block">
        <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 cursor-pointer transition-all hover:scale-110 shadow-lg">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd" />
          </svg>
        </div>
        <div className="w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center text-white hover:bg-purple-700 cursor-pointer transition-all hover:scale-110 shadow-lg">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
